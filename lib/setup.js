...
setup.parse = function (settings) {
  ...
  // twice replace, because of nested templating string
  ...
  _start = tools.string.template(_start, settings)

  let _stop = tools.string.template(_templates.engines[settings.engine].stop, settings)
  _stop = tools.string.template(_stop, settings)

  let _logrotate = tools.string.template(_templates.logrotate, settings)
  _logrotate = tools.string.template(_logrotate, settings)
